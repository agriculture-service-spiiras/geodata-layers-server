...
const mockFoundLayers = [
  {
    layerId: "real_data:detect_info_2-line",
    objects: [
      {
        type: "Feature",
        properties: {},
...
class Model extends RESTDataSource {
  ...
  getLayers() {
    ...
    // const foundLayers = mockFoundLayers;
    // return foundLayers;
  }

  getLayerObjects(layerId) {
    return this.get(`objects-geodata/${layerId}`);
    // const foundObjects = mockGettingObjects;
    // return foundObjects;
  }
